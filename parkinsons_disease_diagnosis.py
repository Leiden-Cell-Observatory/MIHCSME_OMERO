...
def _(mo):
    mo.md(r"""
    We standardize the features and create PyTorch Dataset & DataLoeader
    """)
    return


@app.cell(hide_code=True)
def _(DATA_PATH, DataLoader, Dataset, StandardScaler, np, pd):
    # Load the dataset
    ...
    return X_scaled, data, data_combined, dataloader
...
def _(mo):
    mo.md(r"""
    CVAE Architecture Implementaion
    """)
    return
...
def _(mo):
    mo.md(r"""
    Function to train CVAE, you can use any other otimizer from PyTorch, and tweet `num_epochs`.
    """)
    return
...
def _(mo):
    mo.md(r"""
    Train the Model, you can experiment with different `latent_dim`
    """)
    return


@app.cell(hide_code=True)
def _(CVAE, F, X_scaled, dataloader, optim, torch, train_cvae_model):
    ...
    return latent_dim, model, train_loss
...
@app.cell(hide_code=True)
def _(plot_train_loss, train_loss):
...
def _(mo):
    mo.md(r"""
    Function to generate conditional synthetic data using a trained CVAE model.
    """)
    return
...
def _(mo):
    mo.md(r"""
    Generate 500 conditional synthetic data using a trained CVAE model.
    """)
    return


@app.cell(hide_code=True)
def _(generate_conditional_synthetic_data, latent_dim, model):
...
def _(mo):
    mo.md(r"""
    We use **RandomForestClassifier** for classification here.
    """)
    return


@app.cell(hide_code=True)
def _(RandomForestClassifier, accuracy_score, np):
...
@app.cell(hide_code=True)
def _(pd, split_data, statistics, train_and_evaluate_classifier):
...
@app.cell(hide_code=True)
def _(data_combined, label_data, mo, repeated_evaluation, synthetic_data):
...
@app.cell(hide_code=True)
def _(mo, np, plot_lasso_coefficients, synthetic_data):
    mo.md(f"""
...
def _(mo):
    mo.md(r"""
    Since we've illustrated the implementation of CVAE, we will be more concise here.
    """)
    return
...
@app.cell(hide_code=True)
def _(Autoencoder, synthetic_data, train_autoencoder):
...
@app.cell
def _(autoencoder_train_loss, plot_train_loss):
...
def _(mo):
    mo.md(r"""
    Transform data with the trained AutoEncoder
    """)
    return


@app.cell(hide_code=True)
def _(autoencoder, synthetic_data, transform_data):
...
def _(mo):
    mo.md(r"""
    We formally create the DataFrame here.
    """)
    return


@app.cell(hide_code=True)
def _(pd, transformed_synthetic_data):
    df = pd.DataFrame(
...
@app.cell(hide_code=True)
def _(create_distplot, transformed_synthetic_data):
    create_distplot(transformed_synthetic_data)
    return


@app.cell(hide_code=True)
def _(create_violin, transformed_synthetic_data):
    create_violin(transformed_synthetic_data)
    return


@app.cell(hide_code=True)
def _(create_pairplot, df):
    create_pairplot(df)
    return


@app.cell(hide_code=True)
def _(correlation_heatmap, df):
...
@app.cell(hide_code=True)
def _(train_test_split, transformed_synthetic_data):
...
@app.cell(hide_code=True)
def _(gn_result, knn_result, lda_result, lr_result):
    # prepare for summary
    models = [
        result["model"]
...
@app.cell(hide_code=True)
def _(models, summary_plot, test, valid_scores):
